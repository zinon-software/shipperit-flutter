...
class WidgetBannerDesktop extends StatefulWidget {
  const WidgetBannerDesktop({Key? key}) : super(key: key);

  @override
  _WidgetBannerState createState() => _WidgetBannerState();
}

class _WidgetBannerState extends State<WidgetBannerDesktop> {
  @override
